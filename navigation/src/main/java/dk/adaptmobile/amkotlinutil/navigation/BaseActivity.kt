...
import dk.adaptmobile.amkotlinutil.util.BaseDependencies
...
abstract class BaseActivity : FragmentActivity() {
    ...
    protected fun setup(mainContainer: ChangeHandlerFrameLayout, modalContainer: ChangeHandlerFrameLayout, savedInstanceState: Bundle?, baseDependencies: BaseDependencies) {
