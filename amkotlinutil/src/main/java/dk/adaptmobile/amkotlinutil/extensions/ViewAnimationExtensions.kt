...
fun View?.enterFromBottom(
    ...
    this?.let {
        this.invisible()
        val screenHeight =
            Resources.getSystem().displayMetrics.heightPixels.toFloat() // get device height
        val y = this.y // store initial y
...
fun View.fadeInUp(duration: Long = 250, offset: Float? = null) {
    ...
    afterLatestMeasured {
        ...
        this.alpha = 0f
        this.visible()
        this.animate(true).translationY(0f).alpha(1f).setDuration(duration)
